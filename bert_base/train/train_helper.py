...
def get_args_parser():
    ...
    if os.name == 'nt':
        bert_path = 'D:\pycharm\python_work\bert\BERT-BiLSTM-CRF-NER-master\chinese_L-12_H-768_A-12'
        root_path = r'D:\pycharm\python_work\bert\BERT-BiLSTM-CRF-NER-master'
    else:
    ...
    group1.add_argument('-data_dir', type=str, default=os.path.join(root_path, 'data'),#NERdata
    ...
    group1.add_argument('-output_dir', type=str, default=os.path.join(root_path, 'result'),#output
